        ...
        <main>
          <Container className="pb-16 pt-20 text-center lg:pt-32">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
              At GiveMore, we believe that everyone deserves the opportunity to
              make a difference. That&apos;s why we make it easy for charities
              and donors to connect. We are committed to providing a safe and
              transparent way for people to give, and we believe that everyone
              deserves the opportunity to make a difference.
            </p>
            <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
              When you give through GiveMore, you can be confident that your
              donation is going to a legitimate charity and that it is being
              used to make a positive impact. We have a team of experienced
              fundraising experts who work with charities to ensure that they
              are using our platform effectively and that their campaigns are
              successful. We also have a strict vetting process for all
              charities that list themselves on our platform, so you can be sure
              that you are supporting a reputable organization.
            </p>
            <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
              We believe that everyone deserves the opportunity to make a
              difference, and we are committed to making it easy for people to
              do so. When you give through GiveMore, you can be confident that
              your donation is going to a good cause and that it is being used
          ...
          <div className="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
            ...
            <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
              ...
              <div className="lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:-ml-12 lg:-mt-12 lg:overflow-hidden lg:p-12">
                <img
                  className="w-full max-w-none rounded-xl bg-gray-900 shadow-xl ring-1 ring-gray-400/10 sm:w-[57rem] lg:w-[48rem]"
          ...
          <div className="bg-white py-24 sm:py-32" id="causes">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto max-w-2xl text-center">
                <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Charity Organizations</h2>
                <p className="mt-2 text-lg leading-8 text-gray-600">
                  Find a Charity Organization and donate to them.
                </p>
              </div>
          ...
          <div className="bg-white py-24 sm:py-32">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto max-w-2xl text-center">
                ...
                <p className="mt-2 text-lg leading-8 text-gray-600">
                  Read posts from different Charity Organizations.
                </p>
              </div>
