...
export default async function Page() {
   ...
   .limit(12);
    ...
    const {data: totalCashDonationsDonated, error: totalCashDonationsDonatedError} = await supabase
    ...
    const {data: totalInKindDonated, error: totalInKindDonatedError} = await supabase
    ...
    return (
        <>
            ...
            <br/>
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4x1">Outcomes</h2>
            <br/>
            <h2 className="text-2xl font-bold tracking-tight text-gray-900 sm:text-4x1">Total Cash and In-Kind Donated</h2>
                <p className="mt-2 text-base leading-8 text-gray-600">
