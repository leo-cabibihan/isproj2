...
async function getVerifiedInKindData(column: any, order: any, charity_id: number) {
  var data
...
export default async function VerifiedTable({ searchParams }: any) {
  ...
  const items = await getVerifiedInKindData(column, order, charityId)
      ...
      <TableContainer>
        ...
        <SlideOver title="Filter & Sort Data" buttontext="Filter & Sort Data" variant="solid" color="yellow">
          <div className="flex-col">
              <form className='flex flex-col w-full gap-y-6' action="/dashboard/donations/verifiedInkind" method="GET">
